...
public class Launcher {
	...
	private static final int refresh_time=600000;//10 minutes.
	...
	public static void main(String[] args) {
		...
		Utils.deleteFilesOlderThanNdays(32, logDirectory);//deletes log files older than 32 days.
	...
	/**
	 * 
	 * Routine that runs periodically every refresh_time milliseconds to update the database content and to log to file.
	 * 
	 */
			...
			public void run() {
				...
				while(true){
					...
					for (Machine m:machines.values()){
						...
						machineDatabaseHandler.updateDatabase(m.machine_id, m.article_in_production_label.getText(), m.number_of_pieces_label.getText(), m.errorHappened, 0L);
					}
				}
